...
namespace YAML {
	...
	{
		static Node encode(const Violet::UUID& uuid)
		{
			Node node;
		...
		static bool decode(const Node& node, Violet::UUID& uuid)
		{
...
#define READ_SCRIPT_FIELD(FieldType, Type)             \
	...
	{
		// Not implemented
		VL_CORE_ASSERT(false, "SerializeRuntime Not Implemented!");
	}
	...
	bool SceneSerializer::Deserialize(const std::string& filepath)
	{
		...
		{
			VL_CORE_ERROR("Failed to load .violet file '{0}'\n     {1}", filepath, e.what());
			return false;
		}
		if (!data["Scene"])
			return false;
	...
	{
		VL_CORE_ASSERT(false, "DeserializeRuntime Not Implemented!");
		return false;
	}
